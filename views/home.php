...
<section class="latest_blog_area section_gap">
    <div class="container">
        <div class="section_title text-center">
            <h2 class="title_color">Blogs les plus récents</h2>
        </div>
        <div class="row mb_30">
            <?php foreach($blogs as $key=>$b): ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="images/<?= $b->image ?>" alt="post">
                        </div>
                        <div class="details">
                            <div class="tags">
                            ...
                            <a href="#">
                                <h4 class="sec_h4"><?= ucfirst($b->titre) ?></h4>
                            </a>
                            <p>
                            <?= substr($b->description, 0, 90) ?>...
                            </p>
                        </div>
                    </div>
                </div>
